...
use precompile_utils::prelude::{Address, BoundedBytes};
use sp_core::ConstU32;
use sp_std::vec::Vec;

pub type BitcoinAddressBytes = BoundedBytes<ConstU32<ADDRESS_MAX_BYTE_LENGTH>>;
...
pub type EvmRegistrationPoolOf = (Vec<Address>, Vec<BitcoinAddressBytes>, Vec<BitcoinAddressBytes>);
