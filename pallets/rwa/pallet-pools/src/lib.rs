...
impl Tranche {
	...
	/// Assets deposited but not yet borrowed, preventing dilution when new investors
...
pub struct PoolDetails<AccountId> {
	...
	/// Total amount of assets invested into the pool. (= sum of all tranches' invested)
	pub total: U256,
